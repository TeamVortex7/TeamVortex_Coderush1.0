...
export default function PhysicsPage() {
    // --- Manually list your physics labs here ---
    // Make sure the 'url' matches the path to your HTML files in the `public` folder.
    const physicsLabs = [
        { 
            id: 1, 
            title: "Density Lab", 
            description: "Launch different types of wood into a fluid and manipulate their properties to discover the principles of buoyancy and density firsthand.",
            url: "/labs/densitylab.html" 
        },
        { 
            id: 2, 
            title: "Electromagnetic Generator", 
            description: "Spin a magnet near a coil, adjust the rotation speed, and change the coil's properties to generate electricity and see the principles of induction in action.",
            url: "/labs/generator.html" 
        },
        { 
            id: 3, 
            title: "Rutherford Scattering Simulation", 
            description: "Fire alpha particles at a thin sheet of gold foil and observe their paths to recreate the famous experiment that revealed the structure of the atom.",
            url: "/labs/rutherfordscatteringsimulation.html" 
        },        { 
            id: 4, 
            title: "Solar System", 
            description: "Launch planets into orbit, adjust their mass and velocity, and witness the laws of gravity shape a star system right before your eyes.",
            url: "/labs/solarsystem.html" 
        },        { 
            id: 5, 
            title: "Ohm's Law", 
            description: "Build your own virtual circuits, change the voltage and resistance, and measure the current to prove the fundamental relationship in Ohm's Law.",
