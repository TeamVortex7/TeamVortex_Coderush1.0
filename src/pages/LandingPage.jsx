...
// --- NEW Spline Background Component ---
const SplineBackground = () => {
  return (
    <div className="fixed inset-0 -z-20">
      <Suspense fallback={<div className="bg-gray-900 w-full h-full" />}>
        {/* Updated Spline scene URL */}
        <Spline scene="https://prod.spline.design/sKLu2rpuWzLIJca6/scene.splinecode" />
      </Suspense>
      {/* This overlay is crucial for text readability over the 3D scene */}
...
const Hero = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from(".hero-content", { opacity: 0, y: 50, duration: 1, ease: "power3.out", delay: 0.5 });
    }, heroRef);
    return () => ctx.revert();
  }, []);
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center text-center font-montserrat text-white">
      <div className="container mx-auto px-6 hero-content">
        <h2 className="text-6xl md:text-7xl font-extrabold drop-shadow-lg mb-6">Immersive STEM Education</h2>
